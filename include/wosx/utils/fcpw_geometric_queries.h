...
#include <wosx/utils/reflectance_boundary_bvh/baseline.h>
#ifdef FCPW_USE_ENOKI
    #include <wosx/utils/reflectance_boundary_bvh/mbvh.h>
#else
    #include <wosx/utils/reflectance_boundary_bvh/bvh.h>
#endif
#include <wosx/utils/reflectance_boundary_bvh/robin_bounds.h>
